...
export default function EditProfilePage() {
    ...
    const form = useForm<ProfileFormValues>({
        ...
        defaultValues: {
            ...
            gender:
                (jobSeeker?.profile?.gender as "MALE" | "FEMALE" | "OTHER") ||
                "OTHER",
            mobile: jobSeeker?.profile?.mobile || "",
            description: jobSeeker?.profile?.description || "",
            preferredJobType:
                (jobSeeker?.profile?.preferredJobType as
                    | "REMOTE"
                    | "ONSITE"
                    | "HYBRID") || "REMOTE",
            ...
            currentlyLookingForJob:
                jobSeeker?.profile?.currentlyLookingForJob ?? true,
            openToUrgentJobs: jobSeeker?.profile?.openToUrgentJobs ?? false,
            lastMinuteAvailability:
                jobSeeker?.profile?.lastMinuteAvailability ?? false,
        },
    });
        ...
        return (
            <div className="flex h-screen items-center justify-center">
                <p className="text-lg font-medium">
                    Access denied. Only jobseekers can edit their profile.
                </p>
            </div>
        );
    }
                                ...
                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                                    <div className="space-y-0.5">
                                        ...
                                        <div className="text-sm text-muted-foreground">
                                            Indicate if you're available for
