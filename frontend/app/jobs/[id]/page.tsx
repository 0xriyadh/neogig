...
export default async function JobPage({ params }: JobPageProps) {
  const job = await fetchTrpc<Job>('job.getById', { id: params.id }).catch(() => null);
        ...
        <Card>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="text-muted-foreground mt-1">{company?.name || 'Company not found'}</p>
                </div>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              <JobQuestionForm jobId={job.id} companyId={job.companyId} />
            </div>
          </CardContent>
        </Card>
      </div>
