...
export function JobFilters() {
  ...
  const [workType, setWorkType] = useQueryState('workType', {
    defaultValue: '',
  });
  ...
  const handleJobTypeChange = useCallback((typeId: string, checked: boolean) => {
  ...
  }, [setSelectedJobTypes, setExperienceLevel, setSalaryRange, setLocation, setWorkType, setSelectedSkills, setShowUrgentOnly]);
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="urgent-jobs">Show urgent jobs only</Label>
          </div>
